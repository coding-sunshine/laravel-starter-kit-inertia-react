...
const variantClass = {
    ...
    success: 'bg-emerald-50/90 text-emerald-700/90 border-emerald-200/40 dark:bg-emerald-500/20 dark:text-emerald-300 dark:border-emerald-400/30',
    warning: 'bg-amber-50/90 text-amber-700/90 border-amber-200/40 dark:bg-amber-500/20 dark:text-amber-300 dark:border-amber-400/30',
    critical: 'bg-red-50/90 text-red-700/90 border-red-200/40 dark:bg-red-500/20 dark:text-red-300 dark:border-red-400/30',
