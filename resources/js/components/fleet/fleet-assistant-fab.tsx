...
export function FleetAssistantFab() {
    ...
    return (
        <>
            <Button
                size="icon"
                className="fleet-assistant-fab fixed bottom-6 right-6 z-50 size-14 rounded-full shadow-lg focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                ...
                <SheetContent side="right" className="w-full sm:max-w-md">
                    <SheetHeader className="pb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <SheetTitle className="text-lg">Fleet Assistant</SheetTitle>
                                <SheetDescription>
                                    Ask about vehicles, drivers, trips, and more.
                                </SheetDescription>
                            </div>
                        </div>
                    </SheetHeader>
                        ...
                        <div className="flex flex-col gap-2">
                            {SUGGESTIONS.map((text, i) => (
                                <button
                                    ...
                                    className="flex items-center gap-2 rounded-lg border border-border bg-muted/30 px-4 py-3 text-left text-sm transition-colors hover:border-primary/40 hover:bg-muted/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                                    style={{
