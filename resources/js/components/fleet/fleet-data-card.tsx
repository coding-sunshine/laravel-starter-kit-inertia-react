 ...
 */
const cardHeaderRowClass = 'mb-2 flex h-7 items-center justify-between';
...
export const fleetDataCardListClass =
...
export const fleetDataCardRowSecondaryClass =
