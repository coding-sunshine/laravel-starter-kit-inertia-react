...
const statusStyles: Record<string, string> = {
    ...
    unloading: 'bg-blue-100 text-blue-800 dark:bg-blue-950/50 dark:text-blue-300',
    ...
    disputed: 'bg-amber-100 text-amber-800 dark:bg-amber-950/50 dark:text-amber-300',
