...
export const rrmcsGlossary: Record<string, string> = {
    ...
    Demurrage:
        'Penalty charged when loading/unloading exceeds the allowed free time (hours × MT × rate).',
    'Free time':
        'Hours allowed by railways to load/unload a rake before demurrage charges begin.',
    'e-Demand':
        'Electronic indent booking system used by Indian Railways for rake placement requests.',
    ...
    Weighment:
        'The act of weighing wagons (or vehicles) at a weighbridge to record gross, tare, and net weights.',
    Overload:
        'When wagon weight exceeds the permissible carrying capacity, attracting penalties from railways.',
    Challan:
        'Transport document accompanying a vehicle shipment with quantity, origin, and destination details.',
    Reconciliation:
        'Comparing weights at different points (mine, siding, RR, power plant) to detect variance or loss.',
    Penalty:
        'Financial charge imposed for demurrage, overloading, or other rule violations during rake operations.',
    'Power Plant Receipt':
        'Weight record from the destination power plant, used as the final reconciliation point.',
    Variance:
        'Difference in weight between two measurement points (e.g., siding weighment vs RR weight).',
    'Stock Ledger':
        'Running record of coal inventory at a siding — updated by arrivals, dispatches, and adjustments.',
};
