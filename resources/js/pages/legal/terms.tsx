            ...
            <div className="min-h-svh bg-background">
                ...
                <main className="mx-auto max-w-3xl px-4 py-8">
                    ...
                    <div className="prose prose-neutral dark:prose-invert max-w-none">
                        ...
                        <h2 className="mt-6 text-lg font-medium">1. Acceptance of terms</h2>
                        <p>
                            By accessing or using this service, you agree to be bound by these terms.
                            If you do not agree, do not use the service.
                        </p>
                        <h2 className="mt-6 text-lg font-medium">2. Use of the service</h2>
                        <p>
                            You must use the service only for lawful purposes and in accordance with
