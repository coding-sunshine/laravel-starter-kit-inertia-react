...
export default function PowerPlantReceiptsCreate({ rakes, powerPlants }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Dashboard', href: '/dashboard' },
        { title: 'Reconciliation', href: '/reconciliation' },
        { title: 'Power plant receipts', href: '/reconciliation/power-plant-receipts' },
        { title: 'Add receipt', href: '/reconciliation/power-plant-receipts/create' },
    ];
                ...
                <form onSubmit={handleSubmit} className="max-w-md space-y-4">
                    <div className="grid gap-2">
                        ...
                        <select
                            ...
                            onChange={(e) => form.setData('rake_id', e.target.value)}
                    ...
                    <div className="grid gap-2">
                        ...
                        <select
                            ...
                            onChange={(e) => form.setData('power_plant_id', e.target.value)}
                            className="rounded-md border border-input bg-background px-4 py-2.5 text-sm"
                        >
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            onChange={(e) => form.setData('receipt_date', e.target.value)}
                            className="text-sm"
                        />
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            onChange={(e) => form.setData('rr_reference', e.target.value)}
                            className="text-sm"
                        />
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button
                            type="button"
                            variant="outline"
                            onClick={() => form.get('/reconciliation/power-plant-receipts')}
                        >
                            Cancel
                        </Button>
                    </div>
