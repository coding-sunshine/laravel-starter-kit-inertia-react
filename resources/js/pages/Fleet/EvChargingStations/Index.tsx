...
interface Props {
    evChargingStations: {
        data: EvChargingStationRecord[];
        last_page: number;
        links: { url: string | null; label: string; active: boolean }[];
    };
}

export default function FleetEvChargingStationsIndex({
    evChargingStations,
}: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href="/fleet/ev-charging-stations/create">
                            ...
                            <tbody>
                                {evChargingStations.data.map((row) => (
                                    ...
                                    >
                                        <td className="p-3">
                                            <Link
                                                href={`/fleet/ev-charging-stations/${row.id}`}
                                        ...
                                        <td className="p-3 text-right">
                                            ...
                                            >
                                                <Link
                                                    href={`/fleet/ev-charging-stations/${row.id}/edit`}
                                                >
                                            ...
                                            <Form
                                                action={`/fleet/ev-charging-stations/${row.id}`}
                                                method="delete"
