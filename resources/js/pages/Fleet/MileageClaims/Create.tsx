...
export default function FleetMileageClaimsCreate({
    greyFleetVehicles,
    users,
    statuses,
}: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild>
                        <Link href="/fleet/mileage-claims">Back</Link>
                    </Button>
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.post('/fleet/mileage-claims');
                    }}
                ...
                >
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button type="button" variant="outline" asChild>
                            <Link href="/fleet/mileage-claims">Cancel</Link>
                        </Button>
                    </div>
                </form>
            </div>
