...
export default function FleetMileageClaimsIndex({
    mileageClaims,
    greyFleetVehicles: _greyFleetVehicles,
    users: _users,
    statuses,
}: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href="/fleet/mileage-claims/create">
                ...
                {mileageClaims.data.length === 0 ? (
                    <div className="rounded-lg border border-dashed py-16 text-center">
                        ...
                        <Button asChild className="mt-4">
                            <Link href="/fleet/mileage-claims/create">Add</Link>
                        </Button>
                    </div>
                ) : (
                    <>
                                    ...
                                    {mileageClaims.data.map((row) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3 text-right">
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/mileage-claims/${row.id}`}
                                                    >
                                                        View
                                                    </Link>
                                                </Button>
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/mileage-claims/${row.id}/edit`}
                                                    >
                                                        <Pencil className="ml-1 size-3.5" />
                                                    </Link>
                                                </Button>
                                                <Form
                                                    action={`/fleet/mileage-claims/${row.id}`}
                                                    method="delete"
