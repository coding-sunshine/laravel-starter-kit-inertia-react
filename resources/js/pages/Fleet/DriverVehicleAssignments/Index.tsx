...
export default function FleetDriverVehicleAssignmentsIndex({
    assignments,
    filters,
}: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Fleet', href: '/fleet' },
        {
            ...
            href: '/fleet/driver-vehicle-assignments',
        },
    ];

    const currentOnly =
        filters.is_current === '1' || filters.is_current === 'true';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <form
                        method="get"
                        action="/fleet/driver-vehicle-assignments"
                        className="flex items-center gap-2"
                    >
                        <Label
                            htmlFor="current_only"
                                ...
                                <tbody>
                                    {assignments.data.map((row) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3">
                                                {row.unassigned_date
                                                    ? new Date(row.unassigned_date).toLocaleDateString()
                                                    : '—'}
                                            </td>
                                            <td className="p-3">
                                                {row.is_current ? (
                                                ...
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        if (
                                                            ...
                                                            router.delete(
                                                                `/fleet/driver-vehicle-assignments/${row.id}`,
                                                            );
                                                        }
                                                    }}
                                                >
