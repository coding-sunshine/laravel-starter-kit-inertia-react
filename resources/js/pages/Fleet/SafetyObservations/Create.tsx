...
export default function SafetyObservationsCreate({
    users,
    locations,
    categories,
    statuses,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.post('/fleet/safety-observations');
                    }}
                ...
                >
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            onChange={(e) =>
                                form.setData('action_taken', e.target.value)
                            }
                            className="min-h-[80px] w-full rounded-md border border-input px-3 py-2 text-sm"
                        />
                    </div>
                    <div className="flex gap-2">
                        ...
                        <Button type="button" variant="outline" asChild>
                            <Link href="/fleet/safety-observations">
                                Cancel
                            </Link>
                        </Button>
                    </div>
