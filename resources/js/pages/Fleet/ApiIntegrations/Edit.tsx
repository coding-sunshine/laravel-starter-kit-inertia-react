...
export default function FleetApiIntegrationsEdit({
    apiIntegration,
    integrationTypes,
    syncStatuses,
}: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Edit',
            href: `/fleet/api-integrations/${apiIntegration.id}/edit`,
        },
    ];
    return (
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild>
                        <Link
                            href={`/fleet/api-integrations/${apiIntegration.id}`}
                        >
                            Back
                        </Link>
                    </Button>
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.put(
                            `/fleet/api-integrations/${apiIntegration.id}`,
                        );
                    }}
                ...
                >
                    <div className="space-y-2">
                        ...
                        <Input
                            value={form.data.integration_name}
                            onChange={(e) =>
                                form.setData('integration_name', e.target.value)
                            }
                            required
                        />
                    </div>
                    <div className="grid gap-4 sm:grid-cols-2">
                        <div className="space-y-2">
                            <Label>Type</Label>
                            <select
                                value={form.data.integration_type}
                                onChange={(e) =>
                                    form.setData(
                                        'integration_type',
                                        e.target.value,
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            value={form.data.api_endpoint}
                            onChange={(e) =>
                                form.setData('api_endpoint', e.target.value)
                            }
                        />
                    </div>
                    <div className="space-y-2">
                        ...
                        <Input
                            value={form.data.authentication_type}
                            onChange={(e) =>
                                form.setData(
                                    'authentication_type',
                                    e.target.value,
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        <div className="space-y-2">
                            ...
                            <Input
                                value={form.data.data_sync_frequency}
                                onChange={(e) =>
                                    form.setData(
                                        'data_sync_frequency',
                                        e.target.value,
                        ...
                        <div className="space-y-2">
                            ...
                            <select
                                value={form.data.sync_status}
                                onChange={(e) =>
                                    form.setData('sync_status', e.target.value)
                                }
                                className="h-9 w-full rounded-md border border-input bg-transparent px-3 py-1 text-sm"
                            >
                                {syncStatuses.map((s) => (
