...
export default function FleetReportExecutionsIndex({
    reportExecutions,
    downloadAvailableIds = [],
    filters,
    reports,
}: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                >
                    <div className="space-y-1">
                        ...
                        <select
                            name="report_id"
                            defaultValue={filters.report_id ?? ''}
                ...
                {reportExecutions.data.length === 0 ? (
                    <div className="rounded-lg border border-dashed py-16 text-center">
                        ...
                        <Button asChild className="mt-4">
                            <Link href="/fleet/reports">Go to reports</Link>
                        </Button>
                    </div>
                ) : (
                    <>
                                    ...
                                    {reportExecutions.data.map((row) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3 text-right">
                                                {(
                                                    downloadAvailableIds as number[]
                                                ).includes(row.id) && (
                                                    <Button
                                                        variant="outline"
                                                        size="sm"
                                                    ...
                                                    >
                                                        <a
                                                            href={`/fleet/report-executions/${row.id}/download`}
                                                            download
                                                        >
                                                            Download
                                                        </a>
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/report-executions/${row.id}`}
                                                    >
                                                        View
                                                    </Link>
                                                </Button>
