...
export default function FleetTrailersEdit({ trailer, types, statuses, locations }: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                >
                    ...
                    <div className="flex gap-2">
                        <Button type="submit" disabled={processing}>Update trailer</Button>
                        <Button variant="outline" asChild>
                            <Link href={`/fleet/trailers/${trailer.id}`}>Cancel</Link>
                        </Button>
                    </div>
                </form>
            </div>
