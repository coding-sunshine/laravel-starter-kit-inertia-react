    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <h1 className="text-2xl font-semibold">New sustainability goal</h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <Input id="target_unit" value={data.target_unit} onChange={(e) => setData('target_unit', e.target.value)} className="mt-1" placeholder="e.g. kg, %" />
                                    {errors.target_unit && <p className="mt-1 text-sm text-destructive">{errors.target_unit}</p>}
                                </div>
                            </div>
                            <div className="flex gap-2">
                                <Button type="submit" disabled={processing}>Create sustainability goal</Button>
                                <Button variant="outline" asChild><Link href="/fleet/sustainability-goals">Cancel</Link></Button>
                            </div>
                        </form>
                    </CardContent>
                </Card>
