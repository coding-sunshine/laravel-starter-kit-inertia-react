...
export default function FleetDriverWellnessRecordsEdit({
    ...
    const form = useForm({
        ...
        fatigue_level: (driverWellnessRecord.fatigue_level ?? '') as
            | number
            | '',
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.put(
                            `/fleet/driver-wellness-records/${driverWellnessRecord.id}`,
                        );
                    }}
                ...
                >
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                max={24}
                                step={0.5}
                                value={form.data.rest_hours}
                                onChange={(e) =>
                                    form.setData('rest_hours', e.target.value)
                                }
                            />
                        </div>
                    </div>
                    <div className="space-y-2">
                        ...
                        <select
                            value={form.data.sleep_quality}
                            onChange={(e) =>
                                form.setData('sleep_quality', e.target.value)
                            }
                            className="h-9 w-full rounded-md border border-input bg-transparent px-3 py-1 text-sm"
                        >
                            <option value="">—</option>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                form.setData('mood', e.target.value)
                            }
                        />
                    </div>
                    <div className="space-y-2">
