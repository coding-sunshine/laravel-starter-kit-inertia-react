...
export default function FleetWarrantyClaimsIndex({
    warrantyClaims,
    filters,
    workOrders,
    statuses,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href="/fleet/warranty-claims/create">
                ...
                >
                    <div className="space-y-1">
                        ...
                        <select
                            name="work_order_id"
                            defaultValue={filters.work_order_id ?? ''}
                                ...
                                <tbody>
                                    {warrantyClaims.data.map((row) => (
                                        ...
                                        >
                                            <td className="p-3">
                                                <Link
                                                    href={`/fleet/warranty-claims/${row.id}`}
                                            ...
                                            <td className="p-3">
                                                {row.work_order ? (
                                                    <Link
                                                        href={`/fleet/work-orders/${row.work_order.id}`}
                                                        className="underline"
                                                    >
                                                        {
                                                            row.work_order
                                            ...
                                            <td className="p-3 text-right">
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/warranty-claims/${row.id}/edit`}
                                                    >
                                                        <Pencil className="ml-1 size-3.5" />
                                                    </Link>
                                                </Button>
                                                <Form
                                                    action={`/fleet/warranty-claims/${row.id}`}
                                                    method="delete"
