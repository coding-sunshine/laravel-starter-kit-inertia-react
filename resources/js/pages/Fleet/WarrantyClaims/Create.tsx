...
export default function FleetWarrantyClaimsCreate({
    workOrders,
    statuses,
    presetWorkOrderId,
}: Props) {
                ...
                <form onSubmit={handleSubmit} className="max-w-xl space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setData('claim_amount', e.target.value)
                                }
                                className="mt-1"
                            />
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setData('settlement_amount', e.target.value)
                                }
                                className="mt-1"
                            />
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setData('submitted_date', e.target.value)
                                }
                                className="mt-1"
                            />
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setData('settled_at', e.target.value)
                                }
                                className="mt-1"
                            />
                        </div>
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button type="button" variant="outline" asChild>
                            <Link href="/fleet/warranty-claims">Cancel</Link>
                        </Button>
                    </div>
                </form>
            </div>
