...
export default function FleetCostAllocationsIndex({
    costAllocations,
    filters,
    costCenters,
    costTypes,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href="/fleet/cost-allocations/create">
                ...
                >
                    <div className="space-y-1">
                        ...
                        <select
                            name="cost_center_id"
                            defaultValue={filters.cost_center_id ?? ''}
                    ...
                    <div className="space-y-1">
                        ...
                        <select
                            name="cost_type"
                            defaultValue={filters.cost_type ?? ''}
                                    ...
                                    {costAllocations.data.map((row) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3 text-right">
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/cost-allocations/${row.id}`}
                                                    >
                                                        View
                                                    </Link>
                                                </Button>
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/cost-allocations/${row.id}/edit`}
                                                    >
                                                        <Pencil className="ml-1 size-3.5" />
                                                    </Link>
                                                </Button>
                                                <Form
                                                    action={`/fleet/cost-allocations/${row.id}`}
                                                    method="delete"
