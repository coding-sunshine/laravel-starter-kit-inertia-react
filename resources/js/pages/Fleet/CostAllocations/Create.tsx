...
export default function FleetCostAllocationsCreate({
    costCenters,
    costTypes,
    sourceTypes,
    approvalStatuses,
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild>
                        <Link href="/fleet/cost-allocations">Back</Link>
                    </Button>
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.post('/fleet/cost-allocations');
                    }}
                ...
                >
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button type="button" variant="outline" asChild>
                            <Link href="/fleet/cost-allocations">Cancel</Link>
                        </Button>
                    </div>
                </form>
            </div>
