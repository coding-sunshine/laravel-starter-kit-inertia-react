...
export default function FleetPartsInventoryCreate({ garages, partsSuppliers }: Props) {
    const form = useForm({
        garage_id: '' as number | '',
        part_number: '',
        description: '',
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'New', href: '/fleet/parts-inventory/create' },
    ];
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Fleet – New parts inventory item" />
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild><Link href="/fleet/parts-inventory">Back</Link></Button>
                    <h1 className="text-2xl font-semibold">New parts inventory item</h1>
                </div>
                <form onSubmit={(e) => { e.preventDefault(); form.post('/fleet/parts-inventory'); }} className="max-w-xl space-y-4 rounded-lg border p-6">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button type="button" variant="outline" asChild><Link href="/fleet/parts-inventory">Cancel</Link></Button>
                    </div>
                </form>
            </div>
        </AppLayout>
