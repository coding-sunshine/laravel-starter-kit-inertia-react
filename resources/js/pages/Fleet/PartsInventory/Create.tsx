...
export default function FleetPartsInventoryCreate({
    garages,
    partsSuppliers,
}: Props) {
    const form = useForm({
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild>
                        <Link href="/fleet/parts-inventory">Back</Link>
                    </Button>
                    <h1 className="text-2xl font-semibold">
                        New parts inventory item
                    </h1>
                </div>
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.post('/fleet/parts-inventory');
                    }}
                ...
                >
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                step="any"
                                min={0}
                                value={form.data.reorder_cost}
                                onChange={(e) =>
                                    form.setData('reorder_cost', e.target.value)
                                }
                            />
                        </div>
                    </div>
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                form.setData('storage_location', e.target.value)
                            }
                        />
                    </div>
                    <div className="flex gap-2">
                        ...
                        <Button type="button" variant="outline" asChild>
                            <Link href="/fleet/parts-inventory">Cancel</Link>
                        </Button>
                    </div>
                </form>
            </div>
