...
export default function FleetContractorsCreate({ statuses }: Props) {
    const form = useForm({
        name: '',
        code: '',
        contractor_type: '',
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'New', href: '/fleet/contractors/create' },
    ];
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Fleet – New contractor" />
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild><Link href="/fleet/contractors">Back</Link></Button>
                    <h1 className="text-2xl font-semibold">New contractor</h1>
                </div>
                <form onSubmit={(e) => { e.preventDefault(); form.post('/fleet/contractors'); }} className="max-w-xl space-y-4 rounded-lg border p-6">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        <div className="space-y-2">
                            ...
                            <Input value={form.data.contractor_type} onChange={e => form.setData('contractor_type', e.target.value)} />
                        </div>
                        <div className="space-y-2">
                            <Label>Status</Label>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        <div className="space-y-2">
                            ...
                            <Input value={form.data.tax_number} onChange={e => form.setData('tax_number', e.target.value)} />
                        </div>
                        <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input type="date" value={form.data.insurance_expiry} onChange={e => form.setData('insurance_expiry', e.target.value)} />
                    </div>
                    <div className="space-y-2">
                        <Label>Notes</Label>
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button type="button" variant="outline" asChild><Link href="/fleet/contractors">Cancel</Link></Button>
                    </div>
                </form>
            </div>
        </AppLayout>
