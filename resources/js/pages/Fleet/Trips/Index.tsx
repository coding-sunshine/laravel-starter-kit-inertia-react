...
export default function FleetTripsIndex({
    trips,
    filters,
    vehicles,
    drivers,
                    ...
                    {trips.data.length === 0 ? (
                        <div className="px-6 pb-8">
                            <FleetEmptyState
                                ...
                                aiSuggestion="How do trips get recorded?"
                                features={[
                                    'View trip history with routes and waypoints',
                                    'Track distance, duration, and fuel usage',
                                    'Analyse driver behaviour during trips',
                                ]}
                            />
                        </div>
                    ) : (
