...
interface LeaseRecord { id: number; vehicle_id: number; contract_id?: string | null; lessor_name: string; start_date: string; end_date: string; monthly_payment?: string | number | null; p11d_list_price?: string | number | null; status: string; }
interface Props {
...
export default function FleetVehicleLeasesEdit({ vehicleLease, vehicles, statuses }: Props) {
    const form = useForm({
        ...
        monthly_payment: vehicleLease.monthly_payment != null ? String(vehicleLease.monthly_payment) : '',
        p11d_list_price: vehicleLease.p11d_list_price != null ? String(vehicleLease.p11d_list_price) : '',
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit', href: `/fleet/vehicle-leases/${vehicleLease.id}/edit` },
    ];
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        form.post(`/fleet/vehicle-leases/${vehicleLease.id}`, { forceFormData: true });
    };
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                <form onSubmit={handleSubmit} className="max-w-xl space-y-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button type="button" variant="outline" asChild><Link href={`/fleet/vehicle-leases/${vehicleLease.id}`}>Cancel</Link></Button>
                    </div>
                </form>
            </div>
        </AppLayout>
