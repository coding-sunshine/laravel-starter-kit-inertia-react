...
export default function FleetVehicleLeasesCreate({ vehicles, statuses }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Create', href: '/fleet/vehicle-leases/create' },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Fleet – New vehicle lease" />
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <h1 className="text-2xl font-semibold">New vehicle lease</h1>
