                    ...
                    <div className="flex flex-wrap gap-2">
                        {workOrder.vehicle && (
                            <Button size="sm" asChild>
                                <Link
                                    href={`/fleet/work-orders/create?vehicle_id=${workOrder.vehicle.id}`}
                                >
                                    <Plus className="mr-1.5 size-4" />
                                    Create work order (same vehicle)
                                </Link>
                            </Button>
                        )}
                        <Button variant="outline" size="sm" asChild>
                            <Link
                                href={`/fleet/assistant?context=work_order:${workOrder.id}`}
                                prefetch="click"
                            >
                        ...
                        <Button variant="outline" asChild>
                            <Link href="/fleet/work-orders">Back</Link>
                        </Button>
                    </div>
                </div>
                            ...
                            <CardContent className="space-y-2 text-sm">
                                ...
                                {workOrder.vehicle && (
                                    <p>
                                        ...
                                        <Link
                                            href={`/fleet/vehicles/${workOrder.vehicle.id}`}
                                            className="underline"
                                        >
                                ...
                                {workOrder.assignedGarage && (
                                    <p>
                                        <span className="font-medium">
                                            Garage:
                                        </span>{' '}
                                        {workOrder.assignedGarage.name}
                                    </p>
                                )}
                            </CardContent>
                        </Card>
                        ...
                        <TabsContent value="warranty" className="mt-0">
                            <Card>
                                <CardHeader className="flex flex-row items-center justify-between pb-2">
                                    ...
                                    <Button size="sm" asChild>
                                        <Link
                                            href={`/fleet/warranty-claims/create?work_order_id=${workOrder.id}`}
                                        >
                                            New claim
                                        </Link>
                                    </Button>
                                ...
                                <CardContent>
                                    {claims.length === 0 ? (
                                        <p className="text-sm text-muted-foreground">
                                            No warranty claims.{' '}
                                            <Link
                                                href={`/fleet/warranty-claims?work_order_id=${workOrder.id}`}
                                                className="text-primary underline"
                                            >
                                                View all claims
                                            </Link>{' '}
                                        ...
                                        <ul className="space-y-2 text-sm">
                                            {claims.map((c) => (
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/warranty-claims/${c.id}`}
