...
export default function FleetContractorInvoicesIndex({
    contractorInvoices,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href="/fleet/contractor-invoices/create">
                                    ...
                                    {contractorInvoices.data.map((row) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3 text-right">
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/contractor-invoices/${row.id}`}
                                                    >
                                                        View
                                                    </Link>
                                                </Button>
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/contractor-invoices/${row.id}/edit`}
                                                    >
                                                        <Pencil className="ml-1 size-3.5" />
                                                    </Link>
                                                </Button>
                                                <Form
                                                    action={`/fleet/contractor-invoices/${row.id}`}
                                                    method="delete"
