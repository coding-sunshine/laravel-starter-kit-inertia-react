...
export default function FleetDriverQualificationsIndex({
    driverQualifications,
    filters,
    drivers,
    qualificationTypes,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href="/fleet/driver-qualifications/create">
                ...
                >
                    ...
                    <div className="space-y-1">
                        ...
                        <select
                            ...
                            defaultValue={filters.qualification_type ?? ''}
                                    ...
                                    {driverQualifications.data.map((row) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3 text-right">
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/driver-qualifications/${row.id}`}
                                                    >
                                                        View
                                                    </Link>
                                                </Button>
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/driver-qualifications/${row.id}/edit`}
                                                    >
                                                        <Pencil className="ml-1 size-3.5" />
                                                    </Link>
                                                </Button>
                                                <Form
                                                    action={`/fleet/driver-qualifications/${row.id}`}
                                                    method="delete"
