...
export default function FleetDriverQualificationsShow({
    driverQualification,
}: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-semibold">
                        {driverQualification.qualification_name}
                    </h1>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-2 text-sm">
                        <p>
                            ...
                            {driverQualification.qualification_type}
                        </p>
                        <p>
                            <span className="font-medium">Status:</span>{' '}
                            {driverQualification.status}
                        </p>
                        {driverQualification.driver && (
                            <p>
                                <span className="font-medium">Driver:</span>{' '}
                                {driverQualification.driver.first_name}{' '}
                                {driverQualification.driver.last_name}
                            </p>
                        )}
                        {driverQualification.issue_date && (
                            <p>
                        ...
                        {driverQualification.expiry_date && (
                            <p>
