...
export default function FleetServiceSchedulesCreate({
    serviceTypes,
    intervalTypes,
    intervalUnits,
    vehicles,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        form.transform((d) => ({
            ...
            interval_value:
                d.interval_value === '' ? undefined : Number(d.interval_value),
        }));
                ...
                <form onSubmit={handleSubmit} className="max-w-xl space-y-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button variant="outline" asChild>
                            <Link href="/fleet/service-schedules">Cancel</Link>
                        </Button>
                    </div>
                </form>
            </div>
