...
export default function FleetServiceSchedulesIndex({
    serviceSchedules,
    filters,
    vehicles,
    serviceTypes,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href="/fleet/service-schedules/create">
                                ...
                                <tbody>
                                    {serviceSchedules.data.map((row) => (
                                        ...
                                        >
                                            <td className="p-3">
                                                <Link
                                                    href={`/fleet/service-schedules/${row.id}`}
                                            ...
                                            <td className="p-3 text-right">
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/service-schedules/${row.id}/edit`}
                                                    >
                                                ...
                                                <Form
                                                    action={`/fleet/service-schedules/${row.id}`}
                                                    method="delete"
