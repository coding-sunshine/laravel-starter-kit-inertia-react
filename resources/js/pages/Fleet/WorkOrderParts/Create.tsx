...
export default function FleetWorkOrderPartsCreate({
    workOrder,
    partsInventory,
}: Props) {
    const form = useForm({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        form.transform((d) => ({
            ...d,
            parts_inventory_id:
                d.parts_inventory_id === '' ? undefined : d.parts_inventory_id,
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head
                title={`Fleet – Add part to ${workOrder.work_order_number}`}
            />
