...
export default function VehicleDiscsEdit({
    vehicleDisc,
    vehicles,
    operatorLicences,
    statuses,
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild>
                        <Link href={`/fleet/vehicle-discs/${vehicleDisc.id}`}>
                            Back
                        </Link>
                    </Button>
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.put(`/fleet/vehicle-discs/${vehicleDisc.id}`);
                    }}
