...
export default function FleetPoolVehicleBookingsCreate({
    vehicles,
    users,
    statuses,
}: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild>
                        <Link href="/fleet/pool-vehicle-bookings">Back</Link>
                    </Button>
                    <h1 className="text-2xl font-semibold">
                        New pool vehicle booking
                    </h1>
                </div>
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.post('/fleet/pool-vehicle-bookings');
                    }}
