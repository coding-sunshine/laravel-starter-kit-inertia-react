...
export default function FleetDriversEdit({
    driver,
    statuses,
    licenseStatuses,
    riskCategories,
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        compliance_status: (driver.compliance_status ?? '') as string,
        risk_category: (driver.risk_category ?? '') as string,
    });
