...
interface RecallRecord { id: number; vehicle_id?: number | null; recall_reference: string; make?: string | null; model?: string | null; title?: string | null; description?: string | null; issued_date?: string | null; due_date?: string | null; status: string; completed_at?: string | null; completion_notes?: string | null; }
interface Props {
...
export default function FleetVehicleRecallsEdit({ vehicleRecall, vehicles, statuses }: Props) {
    const form = useForm({
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit', href: `/fleet/vehicle-recalls/${vehicleRecall.id}/edit` },
    ];
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        form.post(`/fleet/vehicle-recalls/${vehicleRecall.id}`, { forceFormData: true });
    };
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                <form onSubmit={handleSubmit} className="max-w-xl space-y-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button type="button" variant="outline" asChild><Link href={`/fleet/vehicle-recalls/${vehicleRecall.id}`}>Cancel</Link></Button>
                    </div>
                </form>
            </div>
        </AppLayout>
