...
export default function FleetVehicleRecallsIndex({
    vehicleRecalls,
    filters,
    vehicles,
    statuses,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href="/fleet/vehicle-recalls/create">
                                ...
                                <tbody>
                                    {vehicleRecalls.data.map((row) => (
                                        ...
                                        >
                                            <td className="p-3">
                                                <Link
                                                    href={`/fleet/vehicle-recalls/${row.id}`}
                                                    className="font-medium hover:underline"
                                                >
                                                    {row.recall_reference}
                                                </Link>
                                            </td>
                                            <td className="p-3">
                                                {row.title ?? '—'}
                                            ...
                                            <td className="p-3 text-right">
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/vehicle-recalls/${row.id}/edit`}
                                                    >
                                                        <Pencil className="ml-1 size-3.5" />
                                                    </Link>
                                                </Button>
                                                <Form
                                                    action={`/fleet/vehicle-recalls/${row.id}`}
                                                    method="delete"
