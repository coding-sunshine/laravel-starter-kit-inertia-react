...
export default function FleetTrainingCoursesCreate({
    categories,
    deliveryMethods,
}: Props) {
    const form = useForm({
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild>
                        <Link href="/fleet/training-courses">Back</Link>
                    </Button>
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.post('/fleet/training-courses');
                    }}
                ...
                >
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                form.setData('duration_hours', e.target.value)
                            }
                        />
                    </div>
                    <div className="flex gap-2">
                        ...
                        <Button type="button" variant="outline" asChild>
                            <Link href="/fleet/training-courses">Cancel</Link>
                        </Button>
                    </div>
                </form>
            </div>
