...
export default function FleetTrainingCoursesEdit({
    trainingCourse,
    categories,
    deliveryMethods,
}: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Edit',
            href: `/fleet/training-courses/${trainingCourse.id}/edit`,
        },
    ];
    return (
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild>
                        <Link
                            href={`/fleet/training-courses/${trainingCourse.id}`}
                        >
                            Back
                        </Link>
                    </Button>
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.put(
                            `/fleet/training-courses/${trainingCourse.id}`,
                        );
                    }}
