...
export default function FleetIncidentsShow({
    incident,
    mediaItems,
    damageAnalysis,
    incidentAnalysis,
    runDamageAssessmentUrl,
    runIncidentAnalysisUrl,
}: Props) {
                        ...
                        <CardContent className="space-y-2 text-sm">
                            {incidentAnalysis?.primary_finding ? (
                                ...
                                <p className="text-muted-foreground">
                                    No AI summary yet. Click Re-analyze to run
                                    incident analysis.
                                </p>
                            )}
                            {incidentAnalysis?.detailed_analysis &&
                                typeof incidentAnalysis.detailed_analysis ===
                                    'object' && (
                                    <>
                                        {(
                                            incidentAnalysis.detailed_analysis as Record<
                                                string,
                                                unknown
                                            >
                                        ).category && (
