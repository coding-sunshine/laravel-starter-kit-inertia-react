...
export default function FleetAlertPreferencesIndex({
    alertPreferences,
}: Props) {
                            ...
                            <tbody>
                                {alertPreferences.map((row) => (
                                    ...
                                    >
                                        ...
                                        <td className="p-3">
                                            {row.email_enabled ? 'Yes' : 'No'}
                                        </td>
                                        <td className="p-3">
                                            {row.in_app_enabled ? 'Yes' : 'No'}
                                        </td>
                                        <td className="p-3 text-right">
                                            ...
                                            >
                                                <Link
                                                    href={`/fleet/alert-preferences/${row.id}/edit`}
                                                >
