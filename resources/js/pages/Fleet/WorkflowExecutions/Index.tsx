...
interface Props {
    workflowExecutions: { data: WorkflowExecutionRecord[]; links: PaginationLink[] };
                            ...
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="border-b bg-muted/50">
                                        ...
                                        <th className="p-3 text-left font-medium">Workflow definition</th>
                                        ...
                                        <tr key={row.id} className="border-b last:border-0">
                                            ...
                                            <td className="p-3 text-right">
                                                <Button variant="outline" size="sm" asChild>
                                                    <Link href={`/fleet/workflow-executions/${row.id}`}>
