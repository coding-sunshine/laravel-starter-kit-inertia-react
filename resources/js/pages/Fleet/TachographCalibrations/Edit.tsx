...
export default function TachographCalibrationsEdit({
    ...
    const form = useForm({
        ...
        telematics_device_id: (tachographCalibration.telematics_device_id ??
            '') as number | '',
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.put(
                            `/fleet/tachograph-calibrations/${tachographCalibration.id}`,
                        );
                    }}
