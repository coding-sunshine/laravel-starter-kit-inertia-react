...
export default function TachographCalibrationsCreate({
    vehicles,
    telematicsDevices,
    statuses,
}: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild>
                        <Link href="/fleet/tachograph-calibrations">Back</Link>
                    </Button>
                    <h1 className="text-2xl font-semibold">
                        New tachograph calibration
                    </h1>
                </div>
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.post('/fleet/tachograph-calibrations');
                    }}
                ...
                >
                    ...
                    <div className="space-y-2">
                        ...
                        <select
                            value={form.data.telematics_device_id || ''}
                            onChange={(e) =>
                                form.setData(
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        <div className="space-y-2">
                            ...
                            <Input
                                type="date"
                                value={form.data.calibration_date}
                                onChange={(e) =>
                                    form.setData(
                                        'calibration_date',
                                        e.target.value,
