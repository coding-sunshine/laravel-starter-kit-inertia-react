    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        form.transform((d) => ({
            ...
            driving_time_minutes:
                d.driving_time_minutes === ''
                    ? null
                    : Number(d.driving_time_minutes),
            total_duty_time_minutes:
                d.total_duty_time_minutes === ''
                    ? null
                    : Number(d.total_duty_time_minutes),
        }));
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                <form onSubmit={handleSubmit} className="max-w-xl space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <Label htmlFor="driving_time_minutes">
                                Driving time (minutes)
                            </Label>
                            <Input
                                id="driving_time_minutes"
                                type="number"
                                min="0"
                                value={
                                    data.driving_time_minutes === ''
                                        ? ''
                                        : data.driving_time_minutes
                                }
                                onChange={(e) =>
                        ...
                        <div>
                            <Label htmlFor="total_duty_time_minutes">
                                Total duty time (minutes)
                            </Label>
                            <Input
                                id="total_duty_time_minutes"
                                type="number"
                                min="0"
                                value={
                                    data.total_duty_time_minutes === ''
                                        ? ''
                                        : data.total_duty_time_minutes
                                }
                                onChange={(e) =>
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button variant="outline" asChild>
                            <Link href="/fleet/driver-working-time">
                                Cancel
                            </Link>
                        </Button>
                    </div>
