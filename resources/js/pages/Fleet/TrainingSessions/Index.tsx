...
interface Row {
    ...
    status: string;
    training_course?: { id: number; course_name: string };
}
interface Props {
    trainingSessions: {
        data: Row[];
...
export default function FleetTrainingSessionsIndex({
    trainingSessions,
    filters,
    courses,
    statuses,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href="/fleet/training-sessions/create">
                ...
                >
                    <div className="space-y-1">
                        ...
                        <select
                            ...
                            defaultValue={filters.training_course_id ?? ''}
                                    ...
                                    {trainingSessions.data.map((row) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3 text-right">
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/training-sessions/${row.id}`}
                                                    >
                                                        View
                                                    </Link>
                                                </Button>
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/training-sessions/${row.id}/edit`}
                                                    >
                                                        <Pencil className="ml-1 size-3.5" />
                                                    </Link>
                                                </Button>
                                                <Form
                                                    action={`/fleet/training-sessions/${row.id}`}
                                                    method="delete"
