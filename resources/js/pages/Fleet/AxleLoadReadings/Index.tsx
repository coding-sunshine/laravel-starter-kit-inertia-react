...
export default function FleetAxleLoadReadingsIndex({
    axleLoadReadings,
    filters,
    vehicles,
}: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                >
                    ...
                    <div className="space-y-1">
                        ...
                        <select
                            name="overload_flag"
                            defaultValue={filters.overload_flag ?? ''}
                            className="h-9 w-32 rounded-md border border-input bg-transparent px-3 py-1 text-sm"
                        >
                            <option value="">All</option>
                                ...
                                <tbody>
                                    {axleLoadReadings.data.map((row) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3">
                                                {row.legal_limit_kg != null
                                                    ? Number(row.legal_limit_kg)
                                                    : '—'}
                                            </td>
                                            <td className="p-3">
                                                {row.overload_flag
                                            ...
                                            <td className="p-3 text-right">
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/axle-load-readings/${row.id}`}
                                                    >
                                                        View
                                                    </Link>
                                                </Button>
