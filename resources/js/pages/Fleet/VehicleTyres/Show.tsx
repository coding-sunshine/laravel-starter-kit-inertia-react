            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-semibold">
                        Vehicle tyre –{' '}
                        {vehicleTyre.vehicle?.registration ?? '—'} (
                        {vehicleTyre.position})
                    </h1>
                    <div className="flex gap-2">
                        <Button variant="outline" size="sm" asChild>
                            <Link
                                href={`/fleet/vehicle-tyres/${vehicleTyre.id}/edit`}
                            >
                                Edit
                            </Link>
                        </Button>
                        <Button variant="ghost" size="sm" asChild>
                            <Link href="/fleet/vehicle-tyres">
                                Back to list
                            </Link>
                        </Button>
                    </div>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-2 text-sm">
                        ...
                        {(vehicleTyre.size || vehicleTyre.brand) && (
                            <p>
                        ...
                        {vehicleTyre.tyre_inventory && (
                            <p>
                                <span className="font-medium">
                                    Tyre inventory:
                                </span>{' '}
                                {vehicleTyre.tyre_inventory.label}
                            </p>
                        )}
                        {vehicleTyre.fitted_at && (
                            <p>
                                <span className="font-medium">Fitted at:</span>{' '}
                                {new Date(
                                    vehicleTyre.fitted_at,
                                ).toLocaleDateString()}
                            </p>
                        )}
                        {vehicleTyre.tread_depth_mm != null && (
                            <p>
                                <span className="font-medium">
                                    Tread depth (mm):
                                </span>{' '}
                        ...
                        {vehicleTyre.odometer_at_fit != null && (
                            <p>
                                <span className="font-medium">
                                    Odometer at fit:
                                </span>{' '}
                                {vehicleTyre.odometer_at_fit}
                            </p>
                        )}
                        {vehicleTyre.notes && (
                            <p>
