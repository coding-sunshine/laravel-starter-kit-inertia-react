...
export default function FleetVehicleTyresIndex({
    vehicleTyres,
    vehicles: _vehicles,
    tyreInventory: _tyreInventory,
    positionOptions,
}: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href="/fleet/vehicle-tyres/create">
                ...
                {vehicleTyres.data.length === 0 ? (
                    <div className="rounded-lg border border-dashed py-16 text-center">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                            No vehicle tyres yet.
                        </p>
                        <Button asChild className="mt-4">
                            <Link href="/fleet/vehicle-tyres/create">Add</Link>
                        </Button>
                    </div>
                ) : (
                    <>
                                    ...
                                    {vehicleTyres.data.map((row) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3 text-right">
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/vehicle-tyres/${row.id}`}
                                                    >
                                                        View
                                                    </Link>
                                                </Button>
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/vehicle-tyres/${row.id}/edit`}
                                                    >
                                                        <Pencil className="ml-1 size-3.5" />
                                                    </Link>
                                                </Button>
                                                <Form
                                                    action={`/fleet/vehicle-tyres/${row.id}`}
                                                    method="delete"
