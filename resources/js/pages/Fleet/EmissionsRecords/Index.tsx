...
export default function FleetEmissionsRecordsIndex({
    emissionsRecords,
    filters,
    vehicles,
    scopes,
    emissionsTypes: _emissionsTypes,
}: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href="/fleet/emissions-records/create">
                ...
                >
                    ...
                    <div className="space-y-1">
                        ...
                        <input
                            type="date"
                            name="record_date"
                            defaultValue={filters.record_date ?? ''}
                            className="h-9 w-40 rounded-md border border-input bg-transparent px-3 py-1 text-sm"
                        />
                    </div>
                                    ...
                                    {emissionsRecords.data.map((row) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3 text-right">
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/emissions-records/${row.id}`}
                                                    >
                                                        View
                                                    </Link>
                                                </Button>
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/emissions-records/${row.id}/edit`}
                                                    >
                                                        <Pencil className="ml-1 size-3.5" />
                                                    </Link>
                                                </Button>
                                                <Form
                                                    action={`/fleet/emissions-records/${row.id}`}
                                                    method="delete"
