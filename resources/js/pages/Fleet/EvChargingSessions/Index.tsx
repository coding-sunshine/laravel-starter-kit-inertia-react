...
export default function FleetEvChargingSessionsIndex({
    evChargingSessions,
    filters,
    vehicles,
    evChargingStations,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href="/fleet/ev-charging-sessions/create">
                ...
                >
                    ...
                    <div className="space-y-1">
                        ...
                        <select
                            ...
                            defaultValue={filters.charging_station_id ?? ''}
                                    ...
                                    {evChargingSessions.data.map((row) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3 text-right">
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/ev-charging-sessions/${row.id}`}
                                                    >
                                                        View
                                                    </Link>
                                                </Button>
                                                ...
                                                >
                                                    <Link
                                                        href={`/fleet/ev-charging-sessions/${row.id}/edit`}
                                                    >
                                                        <Pencil className="ml-1 size-3.5" />
                                                    </Link>
                                                </Button>
                                                <Form
                                                    action={`/fleet/ev-charging-sessions/${row.id}`}
                                                    method="delete"
