...
export default function FleetEvChargingSessionsCreate({
    vehicles,
    drivers,
    evChargingStations,
    sessionTypes,
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild>
                        <Link href="/fleet/ev-charging-sessions">Back</Link>
                    </Button>
                    <h1 className="text-2xl font-semibold">
                        New EV charging session
                    </h1>
                </div>
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.post('/fleet/ev-charging-sessions');
                    }}
