...
export default function FleetEvChargingSessionsEdit({
    evChargingSession,
    vehicles,
    drivers,
    evChargingStations,
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.put(
                            `/fleet/ev-charging-sessions/${evChargingSession.id}`,
                        );
                    }}
                ...
                >
                    ...
                    <div className="space-y-2">
                        ...
                        <select
                            required
                            value={form.data.charging_station_id}
                            onChange={(e) =>
                                form.setData(
                                    'charging_station_id',
                                    Number(e.target.value),
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                form.setData('session_id', e.target.value)
                            }
                            required
                        />
                    </div>
                    <div className="space-y-2">
                        ...
                        <Input
                            type="datetime-local"
                            value={form.data.start_timestamp}
                            onChange={(e) =>
                                form.setData('start_timestamp', e.target.value)
                            }
                        />
                    </div>
                    <div className="space-y-2">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                form.setData('session_type', e.target.value)
                            }
                            className="h-9 w-full rounded-md border border-input bg-transparent px-3 py-1 text-sm"
                        >
                            {sessionTypes.map((s) => (
