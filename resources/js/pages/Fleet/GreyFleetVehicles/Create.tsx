...
export default function FleetGreyFleetVehiclesCreate({ users, drivers }: Props) {
    const form = useForm({
        user_id: '' as number | '',
        driver_id: '' as number | '',
        registration: '',
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'New', href: '/fleet/grey-fleet-vehicles/create' },
    ];
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Fleet – New grey fleet vehicle" />
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" asChild><Link href="/fleet/grey-fleet-vehicles">Back</Link></Button>
                    <h1 className="text-2xl font-semibold">New grey fleet vehicle</h1>
                </div>
                <form onSubmit={(e) => { e.preventDefault(); form.post('/fleet/grey-fleet-vehicles'); }} className="max-w-xl space-y-4 rounded-lg border p-6">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button type="button" variant="outline" asChild><Link href="/fleet/grey-fleet-vehicles">Cancel</Link></Button>
                    </div>
                </form>
            </div>
        </AppLayout>
