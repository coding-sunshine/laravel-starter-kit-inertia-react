...
export default function FleetReportsIndex({
    reports,
    filters,
    reportTypes,
    scheduleFrequencies: _scheduleFrequencies,
    formats: _formats,
}: Props) {
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Saved reports, last run, and run/view/download
                            executions.
                        </p>
                    </div>
                    <Button asChild>
                        <Link href="/fleet/reports/create">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="p-3 text-right">
                                                    ...
                                                    >
                                                        <Link
                                                            href={`/fleet/reports/${row.id}/edit`}
                                                            className="ml-1"
                                                        >
