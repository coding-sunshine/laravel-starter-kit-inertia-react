...
export default function FleetTrainingEnrollmentsShow({
    trainingEnrollment,
}: Props) {
                ...
                <Card>
                    ...
                    <CardContent className="space-y-2 text-sm">
                        <p>
                            ...
                            {trainingEnrollment.training_session
                                ?.session_name ?? '—'}
                        </p>
                        <p>
                            <span className="font-medium">Driver:</span>{' '}
                            {trainingEnrollment.driver
                                ? `${trainingEnrollment.driver.first_name} ${trainingEnrollment.driver.last_name}`
                                : '—'}
                        </p>
                        <p>
                            ...
                            {new Date(
                                trainingEnrollment.enrollment_date,
                            ).toLocaleDateString()}
                        </p>
                        <p>
