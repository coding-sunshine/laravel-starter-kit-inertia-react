...
export default function RiskAssessmentsCreate({
    types,
    statuses,
    subjectOptions,
}: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        form.post('/fleet/risk-assessments');
                    }}
                ...
                >
                    <div className="space-y-2">
                        ...
                        <select
                            required
                            value={
                                form.data.subject_type && form.data.subject_id
                                    ? `${form.data.subject_type}-${form.data.subject_id}`
                                    : ''
                            }
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button type="button" variant="outline" asChild>
                            <Link href="/fleet/risk-assessments">Cancel</Link>
                        </Button>
                    </div>
                </form>
            </div>
