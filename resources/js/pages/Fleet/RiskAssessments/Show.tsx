            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button variant="ghost" size="sm" asChild>
                            <Link href="/fleet/risk-assessments">Back</Link>
                        </Button>
                    </div>
                </div>
                <dl className="max-w-md space-y-2 rounded-lg border p-6">
                    <div>
                        ...
                        <dd className="font-medium">{riskAssessment.title}</dd>
                    </div>
                    <div>
                        <dt className="text-sm text-muted-foreground">Type</dt>
                        <dd>{riskAssessment.type}</dd>
                    </div>
                    <div>
                        <dt className="text-sm text-muted-foreground">
                            Reference
                        </dt>
                        <dd>{riskAssessment.reference_number ?? '—'}</dd>
                    </div>
                    <div>
                        <dt className="text-sm text-muted-foreground">
                            Status
                        </dt>
                        <dd>{riskAssessment.status}</dd>
                    </div>
                    <div>
                        <dt className="text-sm text-muted-foreground">
                            Review date
                        </dt>
                        <dd>{riskAssessment.review_date ?? '—'}</dd>
                    </div>
                    ...
                    {riskAssessment.control_measures && (
                        <div>
                            <dt className="text-sm text-muted-foreground">
                                Control measures
                            </dt>
