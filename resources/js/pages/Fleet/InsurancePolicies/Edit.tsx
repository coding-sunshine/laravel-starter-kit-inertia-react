...
export default function FleetInsurancePoliciesEdit({
    ...
    const form = useForm({
        ...
        premium_amount:
            insurancePolicy.premium_amount != null
                ? String(insurancePolicy.premium_amount)
                : '',
        excess_amount:
            insurancePolicy.excess_amount != null
                ? String(insurancePolicy.excess_amount)
                : '',
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Edit',
            href: `/fleet/insurance-policies/${insurancePolicy.id}/edit`,
        },
    ];
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setData('excess_amount', e.target.value)
                                }
                                className="mt-1"
                            />
                        </div>
