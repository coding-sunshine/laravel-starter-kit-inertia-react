...
export default function Edit({ loader, sidings }: Props) {
  const { data, setData, put, processing, errors } = useForm({
    siding_id: loader.siding_id.toString(),
    loader_name: loader.loader_name,
    code: loader.code,
    loader_type: loader.loader_type,
    make_model: loader.make_model ?? '',
    capacity_mt: loader.capacity_mt != null ? String(loader.capacity_mt) : '',
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    put(`/master-data/loaders/${loader.id}`);
  }

  return (
    <AppLayout>
      <Head title={`Edit Loader - ${loader.loader_name}`} />

      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">Edit Loader</h1>
          <p className="text-muted-foreground">Update loader information</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  />
                  {errors.loader_name && (
                    <p className="text-sm text-red-600 mt-1">{errors.loader_name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.loader_type && (
                    <p className="text-sm text-red-600 mt-1">{errors.loader_type}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.make_model && (
                    <p className="text-sm text-red-600 mt-1">{errors.make_model}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.capacity_mt && (
                    <p className="text-sm text-red-600 mt-1">{errors.capacity_mt}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setData('last_calibration_date', e.target.value)
                    }
                  />
                  {errors.last_calibration_date && (
