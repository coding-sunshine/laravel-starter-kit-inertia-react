...
- **Keep agent instructions in sync**: When changing RBAC or documentation rules, update CLAUDE.md, GEMINI.md, `.github/copilot-instructions.md`, and `.junie/guidelines.md` to match AGENTS.md and `.cursor/rules/laravel-boost.mdc`.
