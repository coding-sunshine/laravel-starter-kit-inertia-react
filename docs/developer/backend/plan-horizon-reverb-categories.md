...
**Durable Workflow & Waterline (added):** [durable-workflow/workflow](https://github.com/durable-workflow/workflow) and [durable-workflow/waterline](https://github.com/durable-workflow/waterline) are installed for long-running workflows; Waterline dashboard at `/waterline` (admin only). See [durable-workflow.md](./durable-workflow.md).
