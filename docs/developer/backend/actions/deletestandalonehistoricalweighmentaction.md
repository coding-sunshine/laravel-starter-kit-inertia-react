# DeleteStandaloneHistoricalWeighmentAction
...
`app/Actions/DeleteStandaloneHistoricalWeighmentAction.php`
...
```php
app(DeleteStandaloneHistoricalWeighmentAction::class)->handle($params);
```

### From Job/Command

```php
(new DeleteStandaloneHistoricalWeighmentAction($dependency))->handle($params);
```
