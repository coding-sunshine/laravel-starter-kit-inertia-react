# RecalculateDailyVehicleEntryRollups
...
`app/Actions/RecalculateDailyVehicleEntryRollups.php`
...
```php
app(RecalculateDailyVehicleEntryRollups::class)->handle($params);
```

### From Job/Command

```php
(new RecalculateDailyVehicleEntryRollups($dependency))->handle($params);
```
