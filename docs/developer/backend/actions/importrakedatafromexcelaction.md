...
`app/Actions/ImportRakeDataFromExcelAction.php`
...
```php
app(ImportRakeDataFromExcelAction::class)->handle($params);
```

### From Job/Command

```php
(new ImportRakeDataFromExcelAction($dependency))->handle($params);
```
