# CreatePersonalOrganizationForUserAction
...
`app/Actions/CreatePersonalOrganizationForUserAction.php`
...
```php
app(CreatePersonalOrganizationForUserAction::class)->handle($params);
```

### From Job/Command

```php
(new CreatePersonalOrganizationForUserAction($dependency))->handle($params);
```
