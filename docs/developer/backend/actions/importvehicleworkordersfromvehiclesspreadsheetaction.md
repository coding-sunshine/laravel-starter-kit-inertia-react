# ImportVehicleWorkordersFromVehiclesSpreadsheetAction
...
`app/Actions/ImportVehicleWorkordersFromVehiclesSpreadsheetAction.php`
...
```php
app(ImportVehicleWorkordersFromVehiclesSpreadsheetAction::class)->handle($params);
```

### From Job/Command

```php
(new ImportVehicleWorkordersFromVehiclesSpreadsheetAction($dependency))->handle($params);
```
