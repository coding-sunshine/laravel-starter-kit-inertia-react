...
`app/Actions/SearchForCommandPaletteAction.php`
...
```php
app(SearchForCommandPaletteAction::class)->handle($params);
```

### From Job/Command

```php
(new SearchForCommandPaletteAction($dependency))->handle($params);
```
