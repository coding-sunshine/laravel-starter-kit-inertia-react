# CreateIndentAndProvisionRakeAction
...
`app/Actions/CreateIndentAndProvisionRakeAction.php`
...
```php
app(CreateIndentAndProvisionRakeAction::class)->handle($params);
```

### From Job/Command

```php
(new CreateIndentAndProvisionRakeAction($dependency))->handle($params);
```
