...
`app/Actions/SyncDemurrageAlertsAction.php`
...
```php
app(SyncDemurrageAlertsAction::class)->handle($params);
```

### From Job/Command

```php
(new SyncDemurrageAlertsAction($dependency))->handle($params);
```
