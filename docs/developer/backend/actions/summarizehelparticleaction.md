...
`app/Actions/SummarizeHelpArticleAction.php`
...
```php
app(SummarizeHelpArticleAction::class)->handle($params);
```

### From Job/Command

```php
(new SummarizeHelpArticleAction($dependency))->handle($params);
```
