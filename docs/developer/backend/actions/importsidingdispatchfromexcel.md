...
`app/Actions/ImportSidingDispatchFromExcel.php`
...
```php
app(ImportSidingDispatchFromExcel::class)->handle($params);
```

### From Job/Command

```php
(new ImportSidingDispatchFromExcel($dependency))->handle($params);
```
