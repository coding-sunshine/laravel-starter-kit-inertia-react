...
`app/Actions/ForceMajeureStitchOutcome.php`
...
```php
app(ForceMajeureStitchOutcome::class)->handle($params);
```

### From Job/Command

```php
(new ForceMajeureStitchOutcome($dependency))->handle($params);
```
