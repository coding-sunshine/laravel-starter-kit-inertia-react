...
`app/Actions/TransferOrganizationOwnershipAction.php`
...
```php
app(TransferOrganizationOwnershipAction::class)->handle($params);
```

### From Job/Command

```php
(new TransferOrganizationOwnershipAction($dependency))->handle($params);
```
