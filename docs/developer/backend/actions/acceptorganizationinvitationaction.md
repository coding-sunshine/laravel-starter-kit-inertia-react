...
`app/Actions/AcceptOrganizationInvitationAction.php`
...
```php
app(AcceptOrganizationInvitationAction::class)->handle($params);
```

### From Job/Command

```php
(new AcceptOrganizationInvitationAction($dependency))->handle($params);
```
