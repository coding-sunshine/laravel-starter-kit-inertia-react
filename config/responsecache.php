...
use App\Http\Middleware\CacheProfiles\PublicContentCacheProfile;
...
return [
     ...
     *  PublicContentCacheProfile caches only guest GET requests and excludes
     *  admin, API, and auth routes.
     */
    'cache_profile' => PublicContentCacheProfile::class,
