...
|--------------------------------------------------------------------------
|
| Maps Spatie settings properties to config() keys. The SettingsOverlay-
| ServiceProvider reads this at boot and writes DB values into config().
|
| Each entry: settings class => [ map => [property => config.key], orgOverridable => bool ]
|
*/
...
return [
    ...
    ThemeSettings::class => [
        'map' => [
            ...
            'sidebar_layout' => 'theme.sidebar_layout',
            'menu_color' => 'theme.menu_color',
            'menu_accent' => 'theme.menu_accent',
        ],
        'orgOverridable' => true,
    ],
    ...
    TenancySettings::class => [
        'map' => [
            ...
            'auto_create_personal_org_for_admins' => 'tenancy.auto_create_personal_organization_for_admins',
            'auto_create_personal_org_for_members' => 'tenancy.auto_create_personal_organization_for_members',
            ...
            'super_admin_default_share_new_to_all_orgs' => 'tenancy.super_admin.default_share_new_to_all_orgs',
        ],
        'orgOverridable' => false,
    ],
