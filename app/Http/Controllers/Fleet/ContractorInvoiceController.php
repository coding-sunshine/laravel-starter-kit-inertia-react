...
final class ContractorInvoiceController extends Controller
{
    public function index(): Response
    {
        ...
        $invoices = ContractorInvoice::query()->with('contractor')->orderByDesc('invoice_date')->paginate(15)->withQueryString();
        ...
        return Inertia::render('Fleet/ContractorInvoices/Index', [
            ...
            'statuses' => array_map(fn ($c) => ['value' => $c->value, 'name' => $c->name], ContractorInvoiceStatus::cases()),
        ]);
    }
    ...
    {
        $this->authorize('create', ContractorInvoice::class);
        ContractorInvoice::create($request->validated());
