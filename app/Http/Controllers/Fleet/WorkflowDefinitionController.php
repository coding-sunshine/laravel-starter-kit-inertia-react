...
final class WorkflowDefinitionController extends Controller
{
    public function index(): Response
    {
        ...
        return Inertia::render('Fleet/WorkflowDefinitions/Index', [
            ...
            'triggerTypes' => array_map(fn (\App\Enums\Fleet\WorkflowTriggerType $c): array => ['value' => $c->value, 'name' => $c->name], \App\Enums\Fleet\WorkflowTriggerType::cases()),
        ]);
    }
    ...
    {
        $this->authorize('create', WorkflowDefinition::class);
        WorkflowDefinition::query()->create($request->validated());
