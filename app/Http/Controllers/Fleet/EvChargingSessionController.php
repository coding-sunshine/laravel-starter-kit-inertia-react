...
final class EvChargingSessionController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Fleet/EvChargingSessions/Index', [
            ...
            'sessionTypes' => array_map(fn (EvChargingSessionType $c): array => ['value' => $c->value, 'name' => $c->name], EvChargingSessionType::cases()),
        ]);
    }
    ...
    {
        $this->authorize('create', EvChargingSession::class);
        EvChargingSession::query()->create($request->validated());
