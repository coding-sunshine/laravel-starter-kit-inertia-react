...
final class DriverQualificationController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Fleet/DriverQualifications/Index', [
            ...
            'qualificationTypes' => array_map(fn (DriverQualificationType $c): array => ['value' => $c->value, 'name' => $c->name], DriverQualificationType::cases()),
            'statuses' => array_map(fn (DriverQualificationStatus $c): array => ['value' => $c->value, 'name' => $c->name], DriverQualificationStatus::cases()),
        ]);
    }
    ...
    {
        $this->authorize('create', DriverQualification::class);
        DriverQualification::query()->create($request->validated());
