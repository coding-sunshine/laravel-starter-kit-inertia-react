...
final class PoolVehicleBookingController extends Controller
{
    public function index(): Response
    {
        ...
        return Inertia::render('Fleet/PoolVehicleBookings/Index', [
            ...
            'statuses' => array_map(fn (PoolVehicleBookingStatus $c): array => ['value' => $c->value, 'name' => $c->name], PoolVehicleBookingStatus::cases()),
        ]);
    }
    ...
    {
        $this->authorize('create', PoolVehicleBooking::class);
        PoolVehicleBooking::query()->create($request->validated());
