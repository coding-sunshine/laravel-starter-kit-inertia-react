...
final class StoreComplianceItemRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('create', \App\Models\Fleet\ComplianceItem::class) ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['nullable', 'string', Rule::in(array_column(ComplianceItemStatus::cases(), 'value'))],
