...
final class ReservationsOverTimeChartWidget extends ChartWidget
{
    public function getHeading(): ?string
    {
        $suffix = TenantContext::check() ? '' : ' — Select an organization to see data';

        return 'Reservations (last 30 days)' . $suffix;
    }
    ...
    protected function getData(): array
    {
        if (! TenantContext::check()) {
            return [
                'datasets' => [['label' => 'Reservations', 'data' => [0], 'backgroundColor' => 'rgba(148, 163, 184, 0.3)', 'borderColor' => 'rgb(148, 163, 184)', 'borderWidth' => 1]],
        ...
        $counts = PropertyReservation::query()
