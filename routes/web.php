...
use App\Http\Controllers\FinanceAssessmentController;
...
use App\Http\Controllers\PotentialPropertyController;
...
Route::middleware(['auth', 'verified'])->group(function (): void {
    ...
    Route::get('projects/{project}', [ProjectsTableController::class, 'show'])->name('projects.show');
    ...
    Route::post('favourites/{project}/toggle', [FavouritesController::class, 'toggle'])->name('favourites.toggle');
    Route::get('featured', [ProjectsTableController::class, 'featured'])->name('projects.featured');
    Route::get('potential-properties', [PotentialPropertyController::class, 'index'])->name('potential-properties.index');
    Route::get('resources', [ResourceLibraryController::class, 'index'])->name('resources.index');
    Route::get('finance-assessments', [FinanceAssessmentController::class, 'index'])->name('finance-assessments.index');
    Route::get('mail-status', [MailStatusController::class, 'index'])->name('mail-status.index');
    ...
    Route::post('contacts/{contact}/refresh-summary', [ContactController::class, 'refreshSummary'])->name('contacts.refresh-summary');
